        ...
        <form action="{{ route('update', $book->bk_id) }}" method="POST" class="bg-white p-8 rounded-lg shadow-md w-[640px]">
            ...
            <div class="grid grid-cols-1 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="image_url" value="{{ $book->bk_image_url }}" id="image_url" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
            </div>
